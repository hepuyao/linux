...
void UKUITaskBar::addWindow(WId window)
{
    ...
    if (!group)
    {
        ...
        //group->setFixedSize(panel()->panelSize()/2,panel()->panelSize()/2);
...
//        group->setFixedSize(panelsize/2, panelsize/2);
//        group->setIconSize(QSize(iconsize,iconsize));
//        group->updateIcon();
//    }
    mLayout->setCellMinimumSize(QSize(mPlugin->panel()->panelSize()/2,mPlugin->panel()->panelSize()/2));
    mLayout->setCellMaximumSize(QSize(mPlugin->panel()->panelSize()/2,mPlugin->panel()->panelSize()/2));
